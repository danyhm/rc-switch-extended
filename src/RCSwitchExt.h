...
// For keeloq you need to increase RCSWITCHEXT_MAX_CHANGES to 23+1+66*2+1=157
#define RCSWITCHEXT_MAX_CHANGES 163        // default 67
...
class RCSwitchExt {
  ...
  public:
    ...
    struct Protocol {
         ...
         *
         * By default, RCSwitchExt assumes that any signals it sends or receives
         ...
         * RCSwitchExt to change how it interprets any HighLow struct FOO: It will
  ...
  private:
    ...
    volatile uint64_t nReceivedValue;
    ...
    */
     ...
     */
    unsigned int timings[RCSWITCHEXT_MAX_CHANGES];
    // buffer of durations of the last four packets, [0] - last
    unsigned int buftimings[4];
    #endif
